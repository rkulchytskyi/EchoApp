...
class YearsArea extends Component {
    componentDidMount(){

        applyExporting(Highcharts);
        applyOffline(Highcharts);

        Highcharts.chart('years-area', {
            chart: {
                type: 'area',
            ...
            series: [
                {
                    ...
                    pointInterval: 1000 * 60 * 60 * 24 * 365, // one year
                    name: 'Rendite',
                    data: [4004, 4761, 4317, 4768, 4018],
                    color: '#ffffff',
                    lineWidth: 1,
                    fillColor: {
...
export default connect(mapStateToProps, mapDispatchToProps)(YearsArea)
